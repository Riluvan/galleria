...
$(".gr-advertice-slider").slick({
  ...
  variableWidth: true,
  prevArrow:
    '<span class="slick-prev"><span class="material-symbols-outlined">arrow_back</span></span>',
  nextArrow:
    '<span class="slick-next"><span class="material-symbols-outlined">arrow_forward</span></span>',
  responsive: [
    {
      breakpoint: 480,
      settings: {
...
$grMovieImages = false;
function grMovieSlider() {
  if ($(window).width() < 767) {
    if (!$grMovieImages) {
      $(".gr-movie-slider").slick({
        dots: true,
        infinite: true,
        arrows: false,
        speed: 2000,
